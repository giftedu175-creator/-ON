...
const nearbyRoutes = {
  haeundae: { safe: [['해운대 해수욕장', '해변 산책 · 안전 상태 확인'], ['동백섬 산책로', '해안 경관 · 도보 이동'], ['청사포 다릿돌전망대', '바다 조망']], scenic: [['해운대 해수욕장', '해변 풍경'], ['청사포 다릿돌전망대', '노을 · 해안 풍경'], ['송정 해수욕장', '해변 산책']], eco: [['동백섬 산책로', '보호 해안 산책'], ['해운대 해수욕장', '친환경 여행 수칙'], ['청사포 다릿돌전망대', '해안 경관']], fun: [['해운대 해수욕장', '해변 액티비티'], ['청사포 다릿돌전망대', '사진 명소'], ['송정 해수욕장', '서핑·카페 즐기기']] },
  gwangalli: { safe: [['광안리 해수욕장', '안전 상태 확인 · 산책'], ['민락수변공원', '광안대교 조망'], ['F1963', '실내 대안 인접']], scenic: [['광안리 해수욕장', '광안대교 조망'], ['민락수변공원', '야경 · 산책'], ['이기대 해안산책로', '해안 절경']], eco: [['광안리 해수욕장', '해변 산책'], ['이기대 해안산책로', '보호 해안 경관'], ['F1963', '친환경 문화 공간']], fun: [['광안리 해수욕장', '해변 놀이'], ['민락수변공원', '야경 포토 스팟'], ['F1963', '문화·전시 즐기기']] },
  busan: { safe: [['용두산공원', '도심 산책'], ['국제시장', '실내·시장 관광'], ['송도 해상케이블카', '바다 조망']], scenic: [['영도 흰여울문화마을', '해안 마을 풍경'], ['송도 해상케이블카', '바다 조망'], ['용두산공원', '부산항 조망']], eco: [['국제시장', '도보 관광'], ['용두산공원', '도심 녹지'], ['송도 해상케이블카', '대중교통 접근']], fun: [['국제시장', '먹거리 탐방'], ['용두산공원', '부산타워 조망'], ['송도 해상케이블카', '바다 위 체험']] },
  seomyeon: { safe: [['부산시민공원', '도심 공원 산책'], ['전포카페거리', '실내 휴식'], ['서면시장', '시장 관광']], scenic: [['전포카페거리', '도심 감성'], ['부산시민공원', '산책'], ['광안리 해수욕장', '해안 야경']], eco: [['부산시민공원', '녹지 산책'], ['전포카페거리', '도보 이동'], ['서면시장', '지역 상권']], fun: [['전포카페거리', '카페 투어'], ['서면시장', '로컬 먹거리'], ['광안리 해수욕장', '야경 즐기기']] },
  airport: { safe: [['대저생태공원', '낙동강 산책'], ['을숙도문화회관', '실내 문화'], ['다대포 해수욕장', '해안 산책']], scenic: [['대저생태공원', '강변 풍경'], ['다대포 해수욕장', '노을 조망'], ['을숙도생태공원', '자연 경관']], eco: [['대저생태공원', '생태 관광'], ['을숙도생태공원', '철새 관찰'], ['을숙도문화회관', '실내 문화']], fun: [['대저생태공원', '자전거·피크닉'], ['다대포 해수욕장', '노을 사진'], ['을숙도문화회관', '문화 체험']] }
};
